...
public:
    ...
    int ClientHello() {
        ...
        if (r0 != 1) {
            ...
            if (r1 != SSL_ERROR_WANT_READ) {
                LogErrorf(logger_, "client hello handshake error r0=%d, r1=%d", r0, r1);
                return -1;
            }
        }
    ...
    int RecvServerHello(char* buf, ssize_t nn) {
        ...
        if (r0 != 1) {
            ...
            if (r1 != SSL_ERROR_WANT_READ) {
                LogErrorf(logger_, "recv server handshake r0=%d, r1=%d", r0, r1);
                return -1;
            }
        }
    ...
    int HandleSessionTicket(char* buf, ssize_t nn) {
        ...
        if (r0 != -1 || r1 != SSL_ERROR_WANT_READ) {
            LogErrorf(logger_, "handle session ticket handshake r0=%d, r1=%d", r0, r1);
            return -1;
        }
        //need more data
        return 1;
